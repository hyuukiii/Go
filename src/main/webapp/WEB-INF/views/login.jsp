...
.loginWrap2 input[type="text"], .loginWrap2 input[type="password"] {
	width: 100%;
	padding: 12px;
	margin-bottom: 18px;
...
<body>
 ...
 %> <span class="notification-badge"><%=unreadNotificationCount%></span>
	...
	<form action="<%=request.getContextPath()%>/login" method="post">
		...
		<div class="loginWrap1">
			<div class="loginWrap2">
				...
				<div class="loginBtn">
					<button type="submit" value="loginBtn" id="loginBtn" disabled>로그인</button>
				</div>
				<ul>
	...
	<script>
		...
		function checkInput() {
			let idValue = user_id.value.trim();
			let pwValue = password.value.trim();
		...
		user_id.addEventListener("input", checkInput);
